...
อ่าน SOLUTION.md จาก feature/bugfix folder แล้ว implement ตาม plan จากนั้นเทสตาม VERIFY.md จนผ่านทั้งหมด แล้วอัปเดต SUMMARY.md

## Usage

```
/approve feature <number|name>                    อนุมัติ feature implementation
/approve bugfix <number|name>                     อนุมัติ standalone bugfix
/approve feature <number|name> bugfix <number|name>   อนุมัติ bugfix ภายใน feature
```
...
/approve feature 1
/approve bugfix 2
/approve feature 1 bugfix 1
/approve feature add-hscode bugfix submit-broken
```
...
- `VERIFY.md` — test cases และ acceptance criteria (บังคับ ถ้าไม่มีให้แจ้ง user แต่ยังดำเนินการต่อได้)
...
หลัง implement ครบแล้ว ให้เทสตาม `VERIFY.md` **ทุก test case**
...
```
✅ Approved & Implemented: [ชื่อ feature/bugfix]
...
- **ห้ามข้าม test** — ทุก test case ใน VERIFY.md ต้องผ่านจริงก่อนออก loop
