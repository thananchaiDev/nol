---
description: "อนุมัติ plan และ implement feature หรือ bugfix"
---

# Approve - อนุมัติ Plan และ Implement

อ่าน SOLUTION.md จาก feature/bugfix folder แล้ว implement ตาม plan จากนั้นเทสตาม TEST_MANUAL.md จนผ่านทั้งหมด แล้วอัปเดต SUMMARY.md
